...
<section class="">
    ...
    <div class="container parent-home">
        ...
        <div
          ...
          "
        >
            <form action="updateSh" method="post">
                <div class="form row">
                    <div class="form-group">
                        ...
                        <select
                                ...
                                required
                        >
                            <option value="<c:out value="${eSchedules.tid}" />"><c:out value="${eSchedules.tName}" /></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select
                                ...
                                required
                        >
                            <option value="<c:out value="${eSchedules.fromId}" />"><c:out value="${eSchedules.fromStation}" /></option>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select
                                ...
                                required
                        >
                            <option value="<c:out value="${eSchedules.toId}" />"><c:out value="${eSchedules.toStation}" /></option>
                            <c:forEach var="stations" items="${stations}">
                                <option value="<c:out value="${stations.tid}" />"> <c:out value=" ${stations.station}" /></option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name="date" value="<c:out value="${eSchedules.date}" />" required/>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Time</label>
                        <input type="time" class="form-control" name="time" value="<c:out value="${eSchedules.time}" />" required/>
                    </div>
                </div>
